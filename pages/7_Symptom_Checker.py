...
if selected_symptoms:
    st.markdown(f"""
    <div style="background:#eaf3de;border:1px solid #97c459;border-radius:10px;padding:0.75rem 1rem;margin-bottom:1rem;font-size:13px;color:#27500a;">
        ✅ <b>{len(selected_symptoms)} symptom(s) selected:</b> {', '.join(selected_symptoms)}
    </div>
    """, unsafe_allow_html=True)
